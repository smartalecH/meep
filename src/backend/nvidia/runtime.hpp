...
enum class failure_point {
  ...
  source_value_copy,
  source_value_sync,
  cw_source_value_copy,
  cw_source_value_sync,
  noisy_add,
  ...
  material_table_tensor_mutation,
  material_table_loop_mutation,
  material_table_shift_mutation,
  material_table_destination_mutation,
  material_table_source_mutation,
  material_table_header_mutation,
  material_ir_upload,
  material_refresh_before_upload,
  material_refresh_after_upload,
